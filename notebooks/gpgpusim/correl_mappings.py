...
# EDIT: this makes absolutely no sense -- should be set([...]) instead of just set()
config_maps = \
{
    ...
    # our custom configuration here (we arbitrarily chose the QV100 config for no reason other than their samples)
    # this also includes QV100-SASS or QV100-PTX because the key is split at -
    "QV100" : set(["TITAN V", "Quadro GV100","Tesla V100-SXM2-32GB", "NVIDIA GeForce GTX 1080"]),
